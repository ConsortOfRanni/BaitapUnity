...
if (n == 2)
{
    ...
    if (moneyUsd > 0)
    {
        ...
        Console.WriteLine($"So tien Vnd tuong ung: {moneyVnd}");
        Console.WriteLine($"Phi chuyen khoan: {fees}");
        Console.WriteLine("Tong tien can tra: " + (moneyVnd + fees) + "Vnd");
    }
    else
    {
...
if (n == 3)
{
    ...
    if (length1 >= width1 && length2 >= width2 && width1 >= 0 && width2 >= 0)
    {
